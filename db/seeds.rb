...
last_names = ["Смирнов", "Иванов", "Кузнецов", "Попов", "Соколов", "Лебедев", "Козлов", "Новиков", "Морозов", "Петров", "Волков", "Соловьев", "Васильев", "Зайцев", "Павлов", "Семенов", "Голубев", "Виноградов", "Богданов", "Воробьев"]
...
projects.each do |p|
  rand(4).times do
    ...
    rand(a.specializations.count).times do
      p.specializations << Specialization.last(rand(a.specializations.count) + 1).first
    end
  end
end
